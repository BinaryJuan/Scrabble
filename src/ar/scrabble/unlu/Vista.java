...
public class Vista {
    ...
    public void mostrarTurno(String jugador, Integer puntaje) {
        System.out.println("--------------------");
        System.out.println("\u001B[0m [Turno de " + jugador + "]");
    ...
    public void mostrarFichaSacada(char ficha) {
        System.out.println("Ficha sacada del montón: " + ficha);
    }
    ...
    public void mostrarAtril(Atril atril) {
        ...
        for (Ficha ficha : atril.getFichas()) {
            posicion++;
            fichasString += ficha.getLetra() + "(" + posicion + ") ";
        }
        System.out.println("Atril: " + fichasString + "[" + atril.getFichas().size() + "]");
    }

    public Integer inputPosicionAtril() {
        System.out.println("\u001B[33m Ingrese la posición en el atril de la ficha que desea colocar (pos. de 1 en adelante): ");
    ...
    public Integer inputPosicionX() {
        System.out.println("Ingrese la posición X en la que desea colocar la ficha: ");
    ...
    public Integer inputPosicionY() {
        System.out.println("Ingrese la posición Y en la que desea colocar la ficha: ");
    ...
    public Integer inputSacarPosicionX() {
        System.out.println("\u001B[33m Ingrese la posición X de la ficha que desea sacar: ");
    ...
    public Integer inputSacarPosicionY() {
        System.out.println("Ingrese la posición Y de la ficha que desea sacar: ");
    ...
    public Integer inputPalabraPosicionInicialX() {
        ...
        System.out.println("Ingrese la posición X de la ficha inicial: ");
    ...
    public Integer inputPalabraPosicionInicialY() {
        System.out.print("\u001B[33m");
        System.out.println("Ingrese la posición Y de la ficha inicial: ");
    ...
    public Integer inputPalabraPosicionFinalX() {
        System.out.print("\u001B[33m");
        System.out.println("Ingrese la posición X de la ficha final: ");
    ...
    public Integer inputPalabraPosicionFinalY() {
        System.out.print("\u001B[33m");
        System.out.println("Ingrese la posición Y de la ficha final: ");
